...
- **F6** — Salomão e o Templo · o reino dividido
- **F7+** — expansão progressiva, Gênesis → Apocalipse

## Fontes e licenças de conteúdo

| Fonte | Uso | Licença |
|---|---|---|
| [Bíblia Livre](https://sites.google.com/site/biblialivre/) (BLIVRE) | **texto integral** de Gn · Êx · Nm · Dt · Js · Jz · Rt · 1–2Sm, via eBible/getBible | CC-BY 3.0 BR |

...
- **Camadas** — as cartas, os Escritos e os profetas como camadas temáticas sobre o panorama · overlay da Bíblia de Jerusalém

## Fontes e licenças de conteúdo

| Fonte | Uso | Licença |
|---|---|---|
| [Bíblia Livre](https://sites.google.com/site/biblialivre/) (BLIVRE) | **texto integral** — 23 livros (o arco narrativo completo, Gn → Ap), via eBible/getBible | CC-BY 3.0 BR |

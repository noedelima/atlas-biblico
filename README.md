...
| **A biblioteca** | [`biblioteca.html`](https://noedelima.github.io/atlas-biblico/biblioteca.html) | **A Bíblia inteira para ler**: 66 livros, 1.189 capítulos, 31.102 versículos — estante por seções, capítulo a capítulo, com carga sob demanda (cada livro só baixa quando aberto) e navegação contínua de Gênesis ao Apocalipse. |
...
**Texto integral**: o diretório [`texto/`](texto/) é o corpus — [`core.js`](texto/core.js) (registro de livros + parser de referências: `"Gn 1:1–2:3"`, `"Nm 13:17-33; 14:26-35"`, `"Gn 22:2,14"`…) e um arquivo por livro. Hoje: **a Bíblia inteira — 66 livros, 31.102 versículos** (Bíblia Livre — revisão moderna e livre da Almeida, CC-BY 3.0 BR); cada página carrega só os livros de que precisa, e a [biblioteca](https://noedelima.github.io/atlas-biblico/biblioteca.html) abre tudo, capítulo a capítulo. Cada perícope, etapa e card oferece **“Ler o texto completo”** com numeração de versículos.
...
| Fonte | Uso | Licença |
|---|---|---|
| [Bíblia Livre](https://sites.google.com/site/biblialivre/) (BLIVRE) | **texto integral** — os 66 livros, via eBible/getBible | CC-BY 3.0 BR |

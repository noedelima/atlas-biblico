...
- **Camadas** — os profetas como camada temática própria sobre o panorama · overlay da Bíblia de Jerusalém · PWA/mobile

## Fontes e licenças de conteúdo

| Fonte | Uso | Licença |
|---|---|---|
| [Bíblia Livre](https://sites.google.com/site/biblialivre/) (BLIVRE) | **texto integral** — 50 livros (a narrativa completa, o NT inteiro e os poéticos), via eBible/getBible | CC-BY 3.0 BR |

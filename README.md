...
- **F9** — Atos e as viagens de Paulo: o mapa vira o Mediterrâneo — rumo ao Gênesis → Apocalipse completo
...
| Fonte | Uso | Licença |
|---|---|---|
| [Bíblia Livre](https://sites.google.com/site/biblialivre/) (BLIVRE) | **texto integral** — 21 livros (o arco do AT + os evangelhos), via eBible/getBible | CC-BY 3.0 BR |
